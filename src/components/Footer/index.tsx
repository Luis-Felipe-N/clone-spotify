        ...
        <footer className={styles.footerContainer}>
            <section>
                ...
                <div className={styles.links}>
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li><a href="Player da web">Player da web</a></li>
                            <li><a href="Aplicativo móvel grátis">Aplicativo móvel grátis</a></li>
                        </ul>
                    </div>
                </div>
                <div className={styles.socialMidia}>
                    <ul>
                        <li>
                            <a target="_blank" href="https://www.instagram.com/challenge/?next=/spotify/">
                                <FaInstagram size={25} />
                            </a>
                        </li>
                        <li>
                            <a target="_blank" href="https://twitter.com/Spotify">
                                <FaTwitter size={25} />
                            </a>
                        </li>
                        <li>
